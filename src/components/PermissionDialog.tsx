...
export function PermissionDialog({ onGrant, onDeny }: PermissionDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/90 dark:bg-black/80 backdrop-blur-sm">
      <div className="relative w-full max-w-md mx-4">
        <div className="bg-white dark:bg-black/90 border border-gray-300/30 dark:border-white/20 rounded-lg shadow-2xl p-6 backdrop-blur-xl">
          <div className="flex justify-center mb-4">
            <div className="relative">
              <div className="absolute inset-0 bg-blue-400/30 dark:bg-blue-500/20 rounded-full blur-xl" />
              <Shield className="size-16 text-blue-600 dark:text-blue-400 relative z-10" />
            </div>
          </div>
          ...
          <div className="bg-gray-100/50 dark:bg-white/5 border border-gray-300/30 dark:border-white/10 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              <Lock className="size-5 text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" />
          ...
          <div className="bg-yellow-100/50 dark:bg-yellow-500/10 border border-yellow-400/30 dark:border-yellow-500/20 rounded-lg p-3 mb-6 flex items-start gap-2">
          ...
          <div className="flex gap-3">
            <Button
              ...
              variant="ghost"
              className={cn(
                "flex-1 border border-gray-300/30 dark:border-white/10 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white",
            ...
            <Button
              ...
              className={cn(
                "flex-1 bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white",
                "border-0 shadow-lg shadow-blue-600/30 dark:shadow-blue-500/20",
